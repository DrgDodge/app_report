...
>
	...
	>
		<h2 class="text-3xl font-bold mb-6 border-b border-gray-700 pb-4">Edit Client</h2>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div class="flex flex-col">
					...
					<input
						type="text"
						id="nr_reg_com"
						bind:value={updatedClient.nr_reg_com}
						class="w-full p-3 bg-gray-700 border border-gray-600 rounded-md"
					/>
				</div>
				<div class="flex flex-col">
				...
				<div class="flex flex-col col-span-2">
					...
					<input
						type="text"
						id="adresa"
						bind:value={updatedClient.adresa}
						class="w-full p-3 bg-gray-700 border border-gray-600 rounded-md"
					/>
				</div>
				<div class="flex flex-col col-span-2">
					...
					<input
						type="text"
						id="locatie"
						bind:value={updatedClient.locatie}
						class="w-full p-3 bg-gray-700 border border-gray-600 rounded-md"
					/>
				</div>
			</div>
